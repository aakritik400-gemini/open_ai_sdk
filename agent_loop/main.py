...
agent = Agent[StoreContext](
    name="Ecommerce Agent Loop API",
    instructions="You help users explore products and calculate prices using tools.",
...
# FastAPI App
# -----------------------------
app = FastAPI(title="Agent Loop API")
...
@app.get("/")
def home():
    return {"message": "Agent Loop API Running"}
